    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ethicities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowedName = table.Column<string>(nullable: true),
                    AboutMe = table.Column<string>(nullable: true),
                    TakePictures = table.Column<bool>(nullable: false),
                    StateId = table.Column<int>(nullable: false),
                    PronounsId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpItems_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvaImage = table.Column<bool>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeetItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MeetItems_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpItems_ApplicationUserId",
                table: "ExpItems",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetItems_ApplicationUserId",
                table: "MeetItems",
                column: "ApplicationUserId");
